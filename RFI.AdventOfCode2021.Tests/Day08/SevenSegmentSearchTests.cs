...
using RFI.AdventOfCode2021.Day08;

namespace RFI.AdventOfCode2021.Tests.Day08
{
    [TestClass]
    public class SevenSegmentSearchTests
    {
        private const string TRAINING_INPUT = @"Day08\TrainingInput.txt";
        private const string REAL_INPUT = @"Day08\RealInput.txt";
