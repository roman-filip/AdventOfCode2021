...
using RFI.AdventOfCode2021.Day09;

namespace RFI.AdventOfCode2021.Tests.Day09
{
    [TestClass]
    public class SmokeBasinTests
    {
        private const string TRAINING_INPUT = @"Day09\TrainingInput.txt";
        private const string REAL_INPUT = @"Day09\RealInput.txt";
